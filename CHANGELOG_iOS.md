...
## [1.89.144](https://github.com/brave/brave-browser/releases/tag/v1.89.144)
 ...
 - Improved hiding logic on server-side 302 redirects. ([#54479](https://github.com/brave/brave-browser/issues/54479))
 - Updated default model list for Brave Leo. ([#52904](https://github.com/brave/brave-browser/issues/52904))
 - [Security] Fixed origin mismatch when opening the link preview page as reported on HackerOne by b4dc4t. ([#53203](https://github.com/brave/brave-browser/issues/53203))
 - Fixed a crash occuring when pasting images into the input field in Leo WebUI. ([#54899](https://github.com/brave/brave-browser/issues/54899))
...
## [1.84.140](https://github.com/brave/brave-browser/releases/tag/v1.84.140)
 ...
 - Disabled User Referral Program reporting when "Automatically send daily usage ping to Brave” is toggled off. ([#50268](https://github.com/brave/brave-browser/issues/50268))
 ...
 - [Security] Fixed download prompt dialog to show the correct host as reported on HackerOne by severusstalin. ([#50341](https://github.com/brave/brave-browser/issues/50341))
 ...
 - Fixed an intermittent crash when tapping on the tabs button. ([#45760](https://github.com/brave/brave-browser/issues/45760))
 - Fixed a crash when opening links in Brave using the share extension on iOS 26. ([#50529](https://github.com/brave/brave-browser/issues/50529))
 ...
 - Fixed the translate button being shown in the URL bar for unsupported websites. ([#50746](https://github.com/brave/brave-browser/issues/50746))
 - Fixed duplicate items being shown when searching bookmarks. ([#48873](https://github.com/brave/brave-browser/issues/48873))
 - Fixed “Manage Website Data” setting tappable area to enable the full row. ([#49562](https://github.com/brave/brave-browser/issues/49562))
 - Upgraded Chromium to 142.0.7444.163. ([#50768](https://github.com/brave/brave-browser/issues/50768))([Changelog for 142.0.7444.163](https://chromium.googlesource.com/chromium/src/+log/141.0.7390.108..142.0.7444.163?pretty=fuller&n=10000))
